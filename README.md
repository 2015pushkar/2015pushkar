...
At Regeneron, I work on a production multi-agent analytics platform built on Snowflake Cortex (Cortex Agents, Cortex Analyst, Cortex Search) and LangGraph, giving commercial analysts self-serve natural-language access to governed enterprise data with grounded, cited answers. Grounding, retrieval, and evaluation work on the platform has cut hallucinations by about 40%.
...
- ☁️ Cloud-native development on AWS, GCP, Azure, Docker
...
- **[CodeViz](https://github.com/prembhajaj/HackBU)**: Interactive React code editor that generates live UML diagrams from source and calls an LLM over REST for readability, structure, and maintainability suggestions. React, Java, Spring Boot, REST, OpenAI API.
